...
# Plot with formatted y-axis, better x-axis, and legend below
...
# Save a ggplot with specific dimensions
ggsave("Death_Trends.png",combined, width = 8, height = 3.5, dpi = 300)

# Read the CSV file - Lee-Carter mx
...
# Read the CSV file - Lee-Carter ex
...
# Plot 2: Gaps with Labels Below Lines
